...
<div class="container py-4">
    ...
    <div class="card border-0 shadow-sm rounded-4 form-card">
        <div class="card-body p-4">
            <h3 class="fw-bold mb-3">✏️ Edit Alat</h3>
            ...
            <form action="{{ route('admin.alat.update', $alat->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control rounded-3" name="deskripsi_alat" rows="4">{{ old('deskripsi_alat', $alat->deskripsi_alat) }}</textarea>
                </div>
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <input type="number" class="form-control rounded-3" 
                               name="jumlah" value="{{ old('jumlah', $alat->jumlah) }}" required>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-select rounded-3" name="status_alat">
                            ...
                            <option value="rusak"    {{ old('status_alat', $alat->status_alat) == 'rusak' ? 'selected' : '' }}>Rusak</option>
                        </select>
                    </div>
                </div>
